...
public class ListActivity extends BaseActivity implements BaseAdapter.AdapterListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BaseAdapter<Contact> adapter = new BaseAdapter<>(binding.actListRvContent, null, R.layout.item_recycler);
        adapter.addAll(contacts);
        adapter.setAdapterListener(this);
        LinearLayoutManager layoutManager = new GridLayoutManager(this, 1, LinearLayoutManager.VERTICAL, false);
